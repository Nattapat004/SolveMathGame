...
class Ep2Stage10 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ep2_stage10)
            ...
            no1.setOnClickListener() {
                ...
                if (calculationList.size != 0) {
                    if ((calculationList[0] == no1.tag as Double) and (latestPressed == 1.00) and !sqrtClicked) {
                        no1.setBackgroundResource(R.drawable.number__6_)
                        calculationList.clear()
                        disableOperators()
                        if (!no2Clicked) {
                            no2Enabled()
                    ...
                    no1.setBackgroundResource(R.drawable.number__7_)
                    calculationList.add(no1.tag as Double)
                    no1Clicked = true
            ...
            no2.setOnClickListener() {
                ...
                if (calculationList.size != 0) {
                    if ((calculationList[0] == no2.tag as Double) and (latestPressed == 2.00) and !sqrtClicked) {
                        no2.setBackgroundResource(R.drawable.number__6_)
                        calculationList.clear()
                        disableOperators()
                        if (!no1Clicked) {
                            no1Enabled()
                    ...
                    no2.setBackgroundResource(R.drawable.number__7_)
                    calculationList.add(no2.tag as Double)
                    no2Clicked = true
                    onNumberButtonClicked()
                    submitResult()
            ...
            no3.setOnClickListener() {
                ...
                if (calculationList.size != 0) {
                    if ((calculationList[0] == no3.tag as Double) and (latestPressed == 3.00) and !sqrtClicked) {
                        no3.setBackgroundResource(R.drawable.number__6_)
                        calculationList.clear()
                        disableOperators()
                        if (!no2Clicked) {
                            no2Enabled()
                    ...
                    no3.setBackgroundResource(R.drawable.number__7_)
                    calculationList.add(no3.tag as Double)
                    no3Clicked = true
                    onNumberButtonClicked()
                    submitResult()
            ...
            no4.setOnClickListener() {
                ...
                if (calculationList.size != 0) {
                    if ((calculationList[0] == no4.tag as Double) and (latestPressed == 4.00) and !sqrtClicked ) {
                        no4.setBackgroundResource(R.drawable.number__6_)
                        calculationList.clear()
                        disableOperators()
                        if (!no2Clicked) {
                            no2Enabled()
                    ...
                    no4.setBackgroundResource(R.drawable.number__7_)
                    calculationList.add(no4.tag as Double)
                    no4Clicked = true
                    onNumberButtonClicked()
                    submitResult()
            ...
            no5.setOnClickListener() {
                ...
                if (calculationList.size != 0) {
                    if ((calculationList[0] == no5.tag as Double) and (latestPressed == 5.00) and !sqrtClicked ) {
                        no5.setBackgroundResource(R.drawable.number__6_)
                        calculationList.clear()
                        disableOperators()
                        if (!no1Clicked) {
                            if (!no1Clicked) {
                    ...
                    no5.setBackgroundResource(R.drawable.number__7_)
                    calculationList.add(no5.tag as Double)
                    no5Clicked = true
                    onNumberButtonClicked()
                    submitResult()
